    ...
    methods
        ...
        function validateResolution(obj)
            ...
            if obj.FOV < obj.FOV_min
                report{end+1} = sprintf('**Current FOV =%6.3f is below lower limit %6.3f. FOV set to:%6.3f\n',obj.FOV, obj.FOV_min, obj.FOV_min);
                obj.FOV = obj.FOV_min;
            elseif obj.FOV > obj.FOV_max
                report{end+1} = sprintf('**Current FOV =%6.3f is above upper limit %6.3f. FOV set to:%6.3f\n',obj.FOV, obj.FOV_max, obj.FOV_max);
                obj.FOV = obj.FOV_max;            
            end
            ...
            if obj.FOV / obj.nSamples < obj.spatialResolution_max
                ...
                toPrint = sprintf('**Current nSamples =%i has to be changed to %i to keep the spatial resolution above the limit:%5.4f\n',obj.nSamples, nSamples_new, obj.spatialResolution_max);
            ...
            if obj.nSamples * obj.bandwidthPerPixel / obj.FOV > obj.systemLimits.maxGrad % maxGrad in Hertz
                ...
                text1 = sprintf('**Current bandwidthPerPixel = %i has to be changed to %i',obj.bandwidthPerPixel, BWpixel_new);
